...
void FEM::SAWADA_XFEM_MatAssySTT(const int ic, MatrixXd &Klocal, VectorXd &Flocal)
{
  ...
  Gauss g1(1),g2(2),g3(3),g5(6),g6(6);
  ...
  for(int i1=0; i1<7; i1++){
    for(int i2=0; i2<7; i2++){
      for(int i3=0; i3<7; i3++){
        ...
        ShapeFunction3D::C3D8_N(NP,g6.point[i1],g6.point[i2],g6.point[i3]);
        ShapeFunction3D::C3D8_N(NV,g6.point[i1],g6.point[i2],g6.point[i2]);
        ShapeFunction3D::C3D8_dNdr(dNPdr,g6.point[i1],g6.point[i2],g6.point[i3]);
        ShapeFunction3D::C3D8_dNdr(dNVdr,g6.point[i1],g6.point[i2],g6.point[i3]); 
        ...
        detJ = dxdr[0][0]*dxdr[1][1]*dxdr[2][2]+dxdr[0][1]*dxdr[1][2]*dxdr[2][0]+dxdr[0][2]*dxdr[1][0]*dxdr[2][1]
               -dxdr[0][2]*dxdr[1][1]*dxdr[2][0]-dxdr[0][1]*dxdr[1][0]*dxdr[2][2]-dxdr[0][0]*dxdr[1][2]*dxdr[2][1];
        weight = g6.weight[i1]*g6.weight[i2]*g6.weight[i3];

...
class ExportFile
{
  public:
    ...
    void export_vti_node_3dir(const string &file, VDOUBLE2D &node, const int nx, const int ny, const int nz, const double dx, const double dy, const double dz);
    ...
    void export_vti_elm_xyz_3dir(const string &file, VDOUBLE3D &element1, VDOUBLE3D &element2, VDOUBLE3D &element3, const int nx, const int ny, const int nz, const double dx, const double dy, const double dz);
    ...
    void export_vti_velocity_cell(const string &file, VDOUBLE3D &u, VDOUBLE3D &v, VDOUBLE3D &w, int nx, const int ny, const int nz, const double dx, const double dy, const double dz);
    ...
    void export_vti_node_2dir_2D(const string &file, VDOUBLE2D &node, const int nx, const int ny, const int nz, const double dx, const double dy, const double dz);
};